...
Feature: Flujo Pickup Android
  ...
  Scenario Outline: flujo de pedido pickup con usuario registrado
    ...
    Then Iniciar orden tipo pickup indicar "<Direccion>" y seleccionar "<Producto>"
    @regresion
    Examples:
   ...
   #   |Brasil |  pruebaautoqabra@gmail.com | Pruebas_2022  |           |                   |
      |Chile | pruebaautoqachi@gmail.com | Pruebas_2022  |  AHUMADA |  McCombo Mediano Doble McFiesta con Queso    |
